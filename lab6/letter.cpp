...
//    setTriangle(2, 0, 1, 5);
    ...
    setQuad(8, 8, 12, 13, 9);
    setQuad(9, 11, 15, 14, 10);
    setQuad(10, 10, 14, 13, 9);
    setQuad(11, 11, 15, 12, 8);

    setQuad(12, 16, 17, 18, 19);
    setQuad(13, 5, 12, 15, 6);
    setQuad(14, 5, 12, 17, 16);
    setQuad(15, 6, 15, 18, 19);

    setQuad(16, 24, 25, 26, 27);
    setQuad(17, 28, 29, 30, 31);
    setQuad(18, 28, 24, 25, 29);
    setQuad(19, 31, 27, 26, 30);
    setQuad(20, 31, 27, 24, 28);
    setQuad(21, 30, 26, 25, 29);

    setQuad(22, 6, 31, 28, 5);
    setQuad(23, 23, 35, 32, 20);
    setQuad(24, 5, 28, 32, 20);
    setQuad(25, 6, 31, 35, 23);

    setQuad(26, 22, 34, 33, 21);
    setQuad(27, 15, 30, 29, 12);
    setQuad(28, 22, 34, 30, 15);
    setQuad(29, 21, 34, 29, 12);
//    setQuad(1, 0, 1, 5, 4);
//    setQuad(2, 8, 9, 10, 11);
